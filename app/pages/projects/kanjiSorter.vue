<template>
  <div>
    ...
    <PageBanner class="bg-yellow-400">
      This new version of the Kanji Sorter is still a WIP, but it should be even better than the old one. Currently, the
      only features that don't work are the About section, the Import List button, and the saving of kanji lists in the
      cloud. However, your list will be saved in the browser now, as long as you don't clear your site data. Another new
      feature is the "Negative Filter" checkbox.
    </PageBanner>
