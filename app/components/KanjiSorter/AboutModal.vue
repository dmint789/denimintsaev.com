    ...
    <div class="max-h-full flex flex-col items-center gap-2 md:gap-4">
      ...
      <div v-if="openTab === 0" class="big-input-output-box about-text-box">
        ...
        <p>
          ...
          <a href="https://patreon.com/denimintsaev" target="_blank">Patreon</a> supporter.
        </p>
        <p>
      ...
      <div v-else-if="openTab === 2" class="big-input-output-box about-text-box">
        <p>
          ...
          <a href="http://rikai.com/library/kanjitables/kanji_codes.unicode.shtml" target="_blank">
            Rikai Kanji Tables
          </a>
        </p>
        <p>
          Lists of kanji based on JLPT level, stroke count and frequency of use in newspapers taken from the
          <a href="https://edrdg.org/wiki/index.php/KANJIDIC_Project" target="_blank">KANJIDIC project</a>
        </p>
        <p>
          List of kanji sorted by frequency of use in novels taken from
          <a href="http://vtrm.net/japanese/kanji-frequency/en" target="_blank">vtrm.net</a>
        </p>
        <p>
          Jōyō kanji list taken from
          <a href="https://en.wikipedia.org/wiki/List_of_j%C5%8Dy%C5%8D_kanji" target="_blank">Wikipedia</a>
        </p>
      </div>
